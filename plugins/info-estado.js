...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} kimm
  ${tradutor.texto1[2]} +56965960343
  ...
  const Message = {
    document: { url: `https://www.instagram.com/the_candy_ff/` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/the_candy_ff/",
        mediaType: 2,
        previewType: "pdf",
        title: "kimm",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/the_candy_ff/",
      },
    },
    caption: info,
    footer: wm,
